...
export const GetPo = (page: number, perpage: number) => Axios.get(process.env.BASE_URL+`/customerPo?page=${page}&limit=${perpage}`);
export const GetAllPo = () => Axios.get(process.env.BASE_URL+`/customerPo`);
export const SearchPo = (page: number, perpage: number, search: string) => Axios.get(process.env.BASE_URL+`/customerPo?page=${page}&limit=${perpage}&search=${search}`);
