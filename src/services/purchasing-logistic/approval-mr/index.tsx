...
export const GetMRForApproval = (page: number, perpage: number,) => Axios.get(process.env.BASE_URL+`/mrDetail?page=${page}&limit=${perpage}`);
export const GetAllMRForApproval = () => Axios.get(process.env.BASE_URL+`/mrDetail`);
