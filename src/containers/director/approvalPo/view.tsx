...
export const ViewApprovalPo = ({ dataSelected, content, showModal }: props) => {
	...
	const approval = async (payload: any) => {
		...
		try {
			const response = await ApprovalPo(dataSelected.id, data);
			if (response.data) {
				toast.success("Approval price po Success", {
					position: "top-center",
					autoClose: 5000,
			...
			toast.error("Approval price po Failed", {
				position: "top-center",
				autoClose: 5000,
				hideProgressBar: true,
				closeOnClick: true,
							...
							<table className='w-full'>
								<tr>
									...
									<td className='sm:w-[50%] md:w-[75%] pl-2 border border-gray-200'>
										{dataSelected.detailMr[0]?.mr?.job_no}
									</td>
								</tr>
								<tr>
									<td className='sm:w-[50%] md:w-[25%] bg-gray-300 pl-2 border border-gray-200'>
									...
									<td className='sm:w-[50%] md:w-[75%] pl-2 border border-gray-200'>
										{dataSelected.detailMr[0]?.mr?.no_mr}
									</td>
								</tr>
								<tr>
									<td className='sm:w-[50%] md:w-[25%] bg-gray-300 pl-2 border border-gray-200'>
									...
									<td className='sm:w-[50%] md:w-[75%] pl-2 border border-gray-200'>
										{moment(dataSelected.detailMr[0]?.mr?.date_mr).format(
											"DD-MMMM-YYYY"
										)}
									</td>
								</tr>
								<tr>
									...
									<td className='sm:w-[50%] md:w-[75%] pl-2 border border-gray-200'>
										{dataSelected.detailMr[0]?.mr?.user.employee.employee_name}
									</td>
								</tr>
								<tr>
									<td className='sm:w-[50%] md:w-[25%] bg-gray-300 pl-2 border border-gray-200'>
									...
									<td className='sm:w-[50%] md:w-[75%] pl-2 border border-gray-200'>
										{
											dataSelected.detailMr[0]?.mr?.user.employee.sub_depart
												.name
										}
									</td>
								</tr>
												...
												{values.detailMr.map((result: any, i: number) => {
													return (
														<tr key={i}>
															...
															<td className='pr-1 w-[15%]'>
																<Input
																	id={`detailMr.${i}.supplier`}
																	name={`detailMr.${i}.supplier`}
