...
export const ViewApprovalDirrect = ({ dataSelected, content, showModal }: props) => {
	...
	const approvalPurchaseDirrect = async (status: string) => {
		setIsLoading(true);
		try {
			const body:any = {
				statusApprove: {
					...
					<div className='mt-8 flex justify-end space-x-2'>
						<div className='flex gap-2 items-center'>
							<button
								...
								disabled={isLoading}
								onClick={() => {
									approvalPurchaseDirrect("approve");
								}}
							>
								{isLoading ? (
									<>
						...
						<div className='flex gap-2 items-center'>
							<button
								...
								disabled={isLoading}
								onClick={() => {
									approvalPurchaseDirrect("reject");
								}}
							>
								{isLoading ? (
									<>
