					...
					{dataSelected.id_cash_advance ? (
						<div className='grid md:grid-cols-1 sm:grid-cols-1 xs:grid-cols-1'>
							<div className='text-right mr-6'>
								...
								<button
									className={`justify-center rounded-full border border-transparent bg-orange-500 hover:bg-blue-400 px-4 py-1 text-sm font-medium text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-gray-500 focus-visible:ring-offset-2 cursor-pointer mr-3`}
									onClick={() => revisi("Supervisor")}
								>
									<div className='flex px-1 py-1'>
										<FileText size={16} className='mr-1' /> Revisi
									</div>
								</button>
								<button
									className={`justify-center rounded-full border border-transparent bg-red-500 hover:bg-blue-400 px-4 py-1 text-sm font-medium text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-gray-500 focus-visible:ring-offset-2 cursor-pointer mr-3`}
									onClick={() => reject()}
								>
									<div className='flex px-1 py-1'>
