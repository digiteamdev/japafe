								...
								values.detailMr.map((result: any, i: number) => {
									return (
										<div key={i}>
											...
											<Section className='grid md:grid-cols-4 sm:grid-cols-2 xs:grid-cols-1 gap-2 mt-4'>
												...
												{/* <div className='w-full'>
													...
													>
														...
														<option value='ppn' selected={result.tax === "ppn"}>
															PPN
														</option>
														<option value='pph' selected={result.tax === "pph"}>
															PPH
														</option>
														<option
															value='ppn_and_pph'
											...
											<Section className='grid md:grid-cols-4 sm:grid-cols-2 xs:grid-cols-1 gap-2 mt-4 border-b border-b-gray-500 pb-2'>
												<div className='w-full'>
													<Input
														id={`detailMr.${i}.disc`}
														name={`detailMr.${i}.disc`}
