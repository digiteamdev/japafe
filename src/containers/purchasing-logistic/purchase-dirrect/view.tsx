...
export const ViewPurchaseDirect = ({
	dataSelected,
	content,
	showModal,
}: props) => {
	...
	return (
		<div className='px-5 pb-2 mt-4 overflow-auto h-[calc(100vh-100px)]'>
			{dataSelected ? (
				<>
					<h1 className='font-bold text-xl'>Purchase dirrect</h1>
						...
						<div className='w-full'>
							<table className='w-full'>
								...
								<tr>
									...
									<td className='sm:w-[50%] md:w-[75%] pl-2 border border-gray-200'>
										{dataSelected.mr?.user.employee.employee_name}
									</td>
								</tr>
								<tr>
									<td className='sm:w-[50%] md:w-[25%] bg-gray-300 pl-2 border border-gray-200'>
									...
									<td className='sm:w-[50%] md:w-[75%] pl-2 border border-gray-200'>
										{dataSelected.mr?.user.employee.sub_depart.name}
									</td>
								</tr>
							</table>
						</div>
