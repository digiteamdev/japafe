...
export const ViewSpjPurchaseService = ({
	dataSelected,
	content,
	showModal,
}: props) => {
				...
				<>
					<div className='grid md:grid-cols-2 sm:grid-cols-1 xs:grid-cols-1'>
						<div className="w-full">
							<h1 className='font-bold text-xl'>Spj Purchase Service</h1>
						</div>
						...
						<div className='w-full'>
							<table className='w-full'>
								...
								<tr>
									...
									<td className='sm:w-[50%] md:w-[75%] pl-2 border border-gray-200'>
										{dataSelected.SrDetail[0]?.purchase?.idPurchase}
									</td>
								</tr>
								<tr>
									<td className='sm:w-[50%] md:w-[25%] bg-gray-300 pl-2 border border-gray-200'>
					...
					<h1 className='font-bold text-xl'>Detail Purchase Service</h1>
					<table className='w-full'>
						<thead>
							<tr>
								<th className='border border-black p-1 text-center'>Job no</th>
								<th className='border border-black p-1 text-center'>No Sr</th>
