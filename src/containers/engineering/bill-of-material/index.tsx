...
export const BillOfMaterial = () => {
	...
	useEffect(() => {
		getBillOfMaterial(page, perPage);
	...
	const getBillOfMaterial = async (page: number, perpage: number) => {
		setIsLoading(true);
		try {
			const response = await GetBillOfMaterial(page, perpage);
			if (response.data) {
	...
	return (
		<div className='mt-14 lg:mt-20 md:mt-20 sm:mt-20 xs:mt-24'>
							...
							return (
								...
								>
									...
									<td className='whitespace-nowrap p-1 w-[10%] text-center'>
										<div>
											<Button
												className='bg-green-500 hover:bg-green-700 text-white p-1 rounded-md mx-1'
												onClick={() => {
													setDataSelected(res);
			...
			>
					{modalContent === "view" ? (
                        <ViewBillOfMaterial dataSelected={dataSelected} />
					) : modalContent === "add" ? (
