...
import { AddPermit } from "../../../services";
...
export const FormCreatePermit = ({ content, showModal }: props) => {
	...
	const addPermit = async (payload: data) => {
		setIsLoading(true);
		try {
			const response = await AddPermit(payload);
			if (response.data) {
