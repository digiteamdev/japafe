...
export const PdfMr = ({ isModal, data, showModalPdf }: props) => {
	const printDocument = () => {
		...
		html2canvas(doc).then((canvas) => {
			...
			pdf.save(`Material_request_${data.no_mr}.pdf`);
		});
	};
										...
										<div className='pt-4'>
											...
											<div className='grid grid-cols-2 text-sm'>
												<div className='border border-t-0 border-r-0 border-black grid grid-cols-3 p-1'>
													<p>Number</p>
													<p className='col-span-2'>: {data.no_mr}</p>
												</div>
